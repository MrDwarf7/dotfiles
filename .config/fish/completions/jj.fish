...
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l config-toml -d 'Additional configuration options (can be repeated) (DEPRECATED)' -r
...
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l config-toml -d 'Additional configuration options (can be repeated) (DEPRECATED)' -r
...
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l config-toml -d 'Additional configuration options (can be repeated) (DEPRECATED)' -r
...
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l config-toml -d 'Additional configuration options (can be repeated) (DEPRECATED)' -r
...
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l config-toml -d 'Additional configuration options (can be repeated) (DEPRECATED)' -r
