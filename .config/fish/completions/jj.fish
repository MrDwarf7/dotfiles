...
complete -c jj -n "__fish_jj_needs_command" -f -a "bench" -d 'Commands for benchmarking internal operations'
...
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -f -a "common-ancestors" -d 'Find the common ancestor(s) of a set of commits'
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -f -a "is-ancestor" -d 'Checks if the first commit is an ancestor of the second commit'
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -f -a "resolve-prefix" -d 'Resolve a commit ID prefix'
complete -c jj -n "__fish_jj_using_subcommand bench; and not __fish_seen_subcommand_from common-ancestors is-ancestor resolve-prefix revset" -f -a "revset" -d 'Walk the revisions in the revset'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -s s -l save-baseline -d 'Name of baseline to save results' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -s b -l baseline -d 'Name of baseline to compare with' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l sample-size -d 'Sample size for the benchmarks, which must be at least 10' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from common-ancestors" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -s s -l save-baseline -d 'Name of baseline to save results' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -s b -l baseline -d 'Name of baseline to compare with' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l sample-size -d 'Sample size for the benchmarks, which must be at least 10' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from is-ancestor" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -s s -l save-baseline -d 'Name of baseline to save results' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -s b -l baseline -d 'Name of baseline to compare with' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l sample-size -d 'Sample size for the benchmarks, which must be at least 10' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from resolve-prefix" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -s f -l file -d 'Read revsets from file' -r -F
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -s s -l save-baseline -d 'Name of baseline to save results' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -s b -l baseline -d 'Name of baseline to compare with' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l sample-size -d 'Sample size for the benchmarks, which must be at least 10' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -s R -l repository -d 'Path to repository to operate on' -r -f -a "(__fish_complete_directories)"
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l at-operation -l at-op -d 'Operation to load the repo at' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l color -d 'When to colorize output' -r -f -a "always\t''
never\t''
debug\t''
auto\t''"
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l config -d 'Additional configuration options (can be repeated)' -r
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l config-file -d 'Additional configuration files (can be repeated)' -r -F
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l ignore-working-copy -d 'Don\'t snapshot the working copy, and don\'t update it'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l no-integrate-operation -d 'Run the command as usual but don\'t integrate any operations'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l ignore-immutable -d 'Allow rewriting immutable commits'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l debug -d 'Enable debug logging'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l quiet -d 'Silence non-primary command output'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -l no-pager -d 'Disable the pager'
complete -c jj -n "__fish_jj_using_subcommand bench; and __fish_seen_subcommand_from revset" -s h -l help -d 'Print help (see more with \'--help\')'
