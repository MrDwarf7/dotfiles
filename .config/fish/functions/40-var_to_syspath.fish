...
function 40-var_to_syspath --wraps=fish_add_path --description "If a provided program is available via pacman, exports a program onto the system PATH via fish's add_path fn"
