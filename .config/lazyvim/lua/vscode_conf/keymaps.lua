...
local function keymaps()
  ...
  pcall(mdel, "n", "[b")
  pcall(mdel, "n", "]b")
  pcall(mdel, "n", "<Leader>bb") -- Switch to Other Buffer
  pcall(mdel, "n", "<Leader>`") -- Switch to Other Buffer

  pcall(mdel, "n", "<Leader>bl") -- Delete Buffers to the Left
  -- mdel("n", "<Leader>bp") -- Toggle pinned buffer
  pcall(mdel, "n", "<Leader>bP") -- Delete non-pinned buffers
  pcall(mdel, "n", "<Leader>br") -- Delete buffers to the Right
  ...
  pcall(mdel, "n", "<Leader>l")

  -- Delete garbage loc list
  pcall(mdel, "n", "<Leader>xl")
  ----- LSP UNBIND
  -- Remove 'format' bind
  pcall(mdel, { "n", "v" }, "<Leader>cf")
  pcall(mdel, "n", "<Leader>cd")

  -- UNBIND inlay hints
  -- mdel("n", "<Leader>uh")

  -- Remove random garbage quit command
  pcall(mdel, "n", "<Leader>qq")

  -- random garbage lazyvim changelog command?????????
  pcall(mdel, "n", "<Leader>L")

  pcall(mdel, "n", "<Leader>fT")
  pcall(mdel, "n", "<Leader>ft")
  pcall(mdel, "n", "<Leader>wd")
  pcall(mdel, "n", "<Leader>wm")
  pcall(mdel, "n", "<Leader>uZ")
  pcall(mdel, "n", "<Leader>uz")

  -- unbind snacks
  pcall(mdel, "n", "<Leader>e")
  pcall(mdel, "n", "<Leader>E")
  pcall(mdel, "n", "<Leader>fn")
