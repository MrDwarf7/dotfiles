...
Regular text can be combined with **bold**, _italic_, and **_bold italic_** emphasis.
...
> **Note:** Quotes can contain `inline code`, _emphasis_, and other Markdown.
...
> “Markdown allows you to write using an easy-to-read, easy-to-write plain text format.” — _Anonymous_
...
Combined emphasis: **_bold italic text_** and **_alternate bold italic_** demonstrate redundancy.
