...
--   -- IF DMS -
--   -- USING:
--   -- Personalization :: Theme & Colors :: Widget Styling :: Popup Transparency: 15%
--   -- Personalization :: Theme & Colors :: Widget Styling :: Shadow Intensity: 12px
--   -- Personalization :: Theme & Colors :: Widget Styling :: Shadow Opacity: 30%
--   shadow = {
--     enabled = true,
--     -- range = 4
--     range = 25,
