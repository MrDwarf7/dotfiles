...
local mon = machines.is_desktop() and machines.monitors("DP-1").output
  or machines.is_laptop() and machines.monitors("eDP-1").output
  or machines.monitors("HDMI-A-1").output

-- local main_mon_desktop = machines.monitors("DP-1").output
--   or machines.monitors("HDMI-A-1").output
--   or machines.monitors("eDP-1").output
