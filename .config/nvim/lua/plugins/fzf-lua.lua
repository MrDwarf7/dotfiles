...
-- local cwd = function()
-- 	if not package.loaded["oil.nvim"] then
-- 		return vim.uv.cwd()
-- 	else
...
-- local cwd_str = cwd()
--
-- local rg_concat_iglob = function(tbl)
-- 	local iglob = ""
-- 	for _, dir in ipairs(tbl) do
-- 		local cwd_and_dir = cwd_str .. "/" .. dir
-- 		iglob = iglob .. " --iglob '!" .. cwd_and_dir .. "/**'"
-- 	end
-- 	return iglob
-- end
--
-- local grep_concat_exclude_dirs = function(tbl)
-- 	local exclude = ""
-- 	for _, dir in ipairs(tbl) do
-- 		local cwd_and_dir = cwd_str .. "/" .. dir
-- 		exclude = exclude .. " --exclude-dir='" .. cwd_and_dir .. "'"
-- 	end
-- 	return exclude
-- end
