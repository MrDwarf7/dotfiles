...
M.separators = {
  -- astronvim.user_opts("heirline.separators", { -- MY_MODIFY
  none = { "", "" },
  left = { "", "  " },
  right = { "  ", "" },
  center = { "  ", "  " },
...
M.attributes = {
  -- astronvim.user_opts("heirline.attributes", {  --MY_MODIFY
...
M.icon_highlights = {
  -- astronvim.user_opts("heirline.icon_highlights", { -- MY_MODIFY
  file_icon = {
...
-- M.sign_handlers = astronvim.user_opts("heirline.sign_handlers", M.sign_handlers) -- MY_MODIFY
