...
Set-PSReadLineKeyHandler -ViMode Insert -Chord "j" -ScriptBlock { mapTwoLetterFunc 'j' 'k' -func $function:setViCommandMode }
Set-PSReadLineKeyHandler -ViMode Insert -Chord "k" -ScriptBlock { mapTwoLetterFunc 'k' 'j' -func $function:setViCommandMode }
