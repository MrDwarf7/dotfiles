...
Register-ArgumentCompleter -Native -CommandName 'aa' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'aa' {
            ...
            [CompletionResult]::new('root', 'root', [CompletionResultType]::ParameterValue, 'Show the current workspace root directory (shortcut for `aa workspace root`)')
            ...
            [CompletionResult]::new('undo', 'undo', [CompletionResultType]::ParameterValue, 'Undo an operation (shortcut for `aa op undo`)')
        ...
        'aa;config' {
            ...
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help (see more with ''--help'')')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help (see more with ''--help'')')
            [CompletionResult]::new('edit', 'edit', [CompletionResultType]::ParameterValue, 'Start an editor on a aa config file')
            [CompletionResult]::new('e', 'e', [CompletionResultType]::ParameterValue, 'Start an editor on a aa config file')
        ...
        'aa;debug;watchman;query-changed-files' {
            [CompletionResult]::new('-R', '-R ', [CompletionResultType]::ParameterName, 'Path to repository to operate on')
            [CompletionResult]::new('--repository', '--repository', [CompletionResultType]::ParameterName, 'Path to repository to operate on')
            [CompletionResult]::new('--at-operation', '--at-operation', [CompletionResultType]::ParameterName, 'Operation to load the repo at')
            [CompletionResult]::new('--at-op', '--at-op', [CompletionResultType]::ParameterName, 'Operation to load the repo at')
        ...
        'aa;git;init' {
            [CompletionResult]::new('--git-repo', '--git-repo', [CompletionResultType]::ParameterName, 'Specifies a path to an **existing** git repository to be used as the backing git repo for the newly created `aa` repo')
            [CompletionResult]::new('-R', '-R ', [CompletionResultType]::ParameterName, 'Path to repository to operate on')
            [CompletionResult]::new('--repository', '--repository', [CompletionResultType]::ParameterName, 'Path to repository to operate on')
            [CompletionResult]::new('--at-operation', '--at-operation', [CompletionResultType]::ParameterName, 'Operation to load the repo at')
            [CompletionResult]::new('--at-op', '--at-op', [CompletionResultType]::ParameterName, 'Operation to load the repo at')
            ...
            [CompletionResult]::new('--config-toml', '--config-toml', [CompletionResultType]::ParameterName, 'Additional configuration options (can be repeated) (DEPRECATED)')
            [CompletionResult]::new('--config-file', '--config-file', [CompletionResultType]::ParameterName, 'Additional configuration files (can be repeated)')
            [CompletionResult]::new('--colocate', '--colocate', [CompletionResultType]::ParameterName, 'Specifies that the `aa` repo should also be a valid `git` repo, allowing the use of both `aa` and `git` commands in the same directory')
            [CompletionResult]::new('--ignore-working-copy', '--ignore-working-copy', [CompletionResultType]::ParameterName, 'Don''t snapshot the working copy, and don''t update it')
            [CompletionResult]::new('--ignore-immutable', '--ignore-immutable', [CompletionResultType]::ParameterName, 'Allow rewriting immutable commits')
            [CompletionResult]::new('--debug', '--debug', [CompletionResultType]::ParameterName, 'Enable debug logging')
            [CompletionResult]::new('--quiet', '--quiet', [CompletionResultType]::ParameterName, 'Silence non-primary command output')
        ...
        'aa;next' {
            ...
            [CompletionResult]::new('--config-toml', '--config-toml', [CompletionResultType]::ParameterName, 'Additional configuration options (can be repeated) (DEPRECATED)')
            [CompletionResult]::new('--config-file', '--config-file', [CompletionResultType]::ParameterName, 'Additional configuration files (can be repeated)')
            [CompletionResult]::new('-e', '-e', [CompletionResultType]::ParameterName, 'Instead of creating a new working-copy commit on top of the target commit (like `aa new`), edit the target commit directly (like `aa edit`)')
            [CompletionResult]::new('--edit', '--edit', [CompletionResultType]::ParameterName, 'Instead of creating a new working-copy commit on top of the target commit (like `aa new`), edit the target commit directly (like `aa edit`)')
        ...
        'aa;util' {
            ...
            [CompletionResult]::new('config-schema', 'config-schema', [CompletionResultType]::ParameterValue, 'Print the JSON schema for the aa TOML config format')
            [CompletionResult]::new('exec', 'exec', [CompletionResultType]::ParameterValue, 'Execute an external command via aa')
