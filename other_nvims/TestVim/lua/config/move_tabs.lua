...
keymap("n", "<C-h>", [[<C-w>h]], opts_desc("win: go to left"))
keymap("n", "<C-j>", [[<C-w>j]], opts_desc("win: go to below"))
keymap("n", "<C-k>", [[<C-w>k]], opts_desc("win: go to above"))
keymap("n", "<C-l>", [[<C-w>l]], opts_desc("win: go to right"))

keymap("n", "<A-z>", [[<C-w>z]], opts_desc("win: close preview win"))

keymap("n", "<C-H>", [[<C-w>H]], opts_desc("win: move to left"))
keymap("n", "<C-J>", [[<C-w>J]], opts_desc("win: move to below"))
keymap("n", "<C-K>", [[<C-w>K]], opts_desc("win: move to above"))
keymap("n", "<C-L>", [[<C-w>L]], opts_desc("win: move to right"))
...
keymap("n", "<A-p>", [[<cmd>lua require('conf.move_tabs').scroll_in_float_win(1)<CR>]], { noremap = true }) -- I may need ot swap these
keymap("n", "<A-n>", [[<cmd>lua require('conf.move_tabs').scroll_in_float_win(-1)<CR>]], { noremap = true })
