...
if vim.g.neovide then
	...
	keymap("", "<C-v>", "<CMD>normal! P<CR>", { desc = "macos paste" })
	keymap("i", "<C-v>", "<CMD>normal! P<CR>", { desc = "macos paste" })
	keymap("c", "<C-v>", '<C-R>"', { desc = "macos paste" })
	keymap("!", "<F3>", "", { callback = neovide_toggle_fullscreen, desc = "macos toggle fullscreen" })
	keymap("", "<F3>", "", { callback = neovide_toggle_fullscreen, desc = "macos toggle fullscreen" })
